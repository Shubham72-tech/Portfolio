...
const HMU_URL = 'https://api.hmu.cool/messages/33f87347a5c9057c701dd9ef54d34824';
...
const CONTENTFUL_URL = `https://cdn.contentful.com/spaces/${CONTENTFUL_SPACE}/entries/?access_token=${CONTENTFUL_TOKEN}`;
const CONTENTFUL_SINGLE_URL = `https://cdn.contentful.com/spaces/${CONTENTFUL_SPACE}/entries`;
